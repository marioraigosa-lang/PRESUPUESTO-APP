...
--
-- SOLO LECTURA — no modifica nada. No forma parte del historial numerado de
-- sql/README.md (no cambia el esquema), es solo una consulta de diagnóstico.
--
...
--   - supabase_categorias_default.sql (columnas es_sistema/descripcion +
--     la versión final del trigger, con categorías por idioma)
