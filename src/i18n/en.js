...
export default {
  ...
  home: {
    ...
    gastosFijosPagadosEtiqueta: 'paid',
    pendienteEtiqueta: 'Pending',
  ...
  tarjetas: {
    ...
    detalle: {
      volverAria: 'Back to home',
      pagarTarjeta: 'Pay card',
      gastadoTitulo: 'Spent',
      pagadoTitulo: 'Paid',
      netoTitulo: 'Net',
      listaTitulo: 'Transactions',
      sinMovimientos: 'No transactions this month.',
      confirmarEliminarPago: 'Delete the payment "{{descripcion}}"? The card\'s debt will go back up.',
    },
    pago: {
      titulo: 'Pay card',
      cerrarAria: 'Close',
      deudaActualLabel: 'Current debt',
      montoLabel: 'Amount to pay',
      cuentaLabel: 'From which account?',
      sinCuentas: "You don't have any accounts registered yet.",
      errorMontoInvalido: 'Enter a valid amount',
      errorSobrepago: "The payment can't exceed the current debt ({{monto}}).",
      errorSinCuenta: 'Select an account',
      errorGuardar: "Couldn't register the payment. Please try again.",
      guardando: 'Paying...',
      confirmar: 'Confirm payment',
      descripcion: '{{tarjeta}} payment',
    },
  },
  ...
  categorias: {
    ...
    formulario: {
      ...
      iconoLabel: 'Icon',
      iconoAria: 'Category icon',
      iconoBuscarPlaceholder: 'Search icon...',
      iconoBuscarAria: 'Search icon',
      iconoOpcionAria: 'Icon {{nombre}}',
      iconoSinResultados: 'No icons found for that name',
      colorLabel: 'Color',
      colorAria: 'Color {{color}}',
      ...
      errorIconoVacio: 'Choose an icon',
  ...
  iconos: {
    grupos: {
      ...
      compras: 'Shopping',
      finanzas: 'Finance',
      trabajo_educacion: 'Work & education',
      personas_mascotas: 'People & pets',
      viajes: 'Travel',
      otros: 'Other',
    },
  },
  ...
  movimientos: {
    formulario: {
      ...
      sufijoOrigen: ' (source)',
      cuentaLabel: 'Account',
      origenLabel: 'Account or card',
      origenCuenta: 'Account',
      origenTarjeta: 'Card',
      tarjetaLabel: 'Card',
      cupoDisponibleSufijo: 'Available: {{monto}}',
      errorTarjetaInvalida: 'Select a valid card',
      avisoCupoExcedido: "This expense exceeds the card's available limit.",
    ...
    elegirCuentaPago: {
      ...
      preguntaTarjeta: 'Which card was it charged to?',
      sinCuentas: "You don't have any accounts registered yet.",
      sinTarjetas: "You don't have any cards registered yet.",
      errorSinCuenta: 'Select an account',
      errorSinTarjeta: 'Select a card',
    ...
    asistente: {
      cerrarAria: 'Close',
      volverAria: 'Back',
      pasoContador: 'Step {{actual}} of {{total}}',
      confirmarDescartar: 'Discard this transaction? The entered data will be lost.',
      siguiente: 'Next',
      guardarBoton: 'Save',
      reintentar: 'Try again',
      editarAria: 'Edit {{campo}}',
      preguntaTipo: 'What do you want to record?',
      trasladoDeshabilitadoNota: 'You need at least 2 accounts',
      preguntaCuentaIngreso: 'Which account did it go into?',
      preguntaCuentaGasto: 'Which account did it come out of?',
      preguntaCuentaRetiro: 'Which account did it come out of?',
      preguntaCuentaOrigenTraslado: 'Source account?',
      preguntaCuentaDestinoTraslado: 'Destination account?',
      preguntaTarjeta: 'Which card?',
  ...
  viajes: {
    ...
    asistente: {
      ...
      volverAria: 'Back',
      pasoContador: 'Step {{actual}} of {{total}}',
      confirmarDescartar: 'Discard this trip? Any entered data will be lost.',
      siguiente: 'Next',
      crearViajeBoton: 'Create trip',
      reintentar: 'Retry',
      editarAria: 'Edit {{campo}}',
      preguntaOrigenDestino: 'From where to where?',
      origenDestinoNota: 'You can leave this blank and fill it in later',
      preguntaFechas: 'When are you traveling?',
      fechasNota: 'You can leave these blank and fill them in later',
      preguntaPersonas: 'How many are going?',
      ...
      nombrePorDefectoGenerico: 'New trip',
    },
    formulario: {
    ...
    detalle: {
      ...
      volverCategoriasAria: "Back to the trip's categories",
      gastadoTitulo: 'Spent',
      restanteTitulo: 'Remaining',
      sinGastosCategoria: 'No expenses in this category yet.',
      abrirSinCategoriaAria: 'View expenses without a category',
    },
    resumen: {
      titulo: 'Trip summary',
    ...
    gastoAsistente: {
      ...
      volverAria: 'Back',
      pasoContador: 'Step {{actual}} of {{total}}',
      confirmarDescartar: 'Discard this expense? Any entered data will be lost.',
      siguiente: 'Next',
      guardarBoton: 'Save',
      reintentar: 'Retry',
      editarAria: 'Edit {{campo}}',
