...
export default {
  ...
  home: {
    ...
    gastosFijosPagadosEtiqueta: 'pagados',
    pendienteEtiqueta: 'Pendiente',
  ...
  movimientos: {
    ...
    elegirCuentaPago: {
      ...
      preguntaTarjeta: '¿A qué tarjeta se cargó?',
      sinCuentas: 'No tienes cuentas registradas todavía.',
      sinTarjetas: 'No tienes tarjetas registradas todavía.',
      errorSinCuenta: 'Selecciona una cuenta',
      errorSinTarjeta: 'Selecciona una tarjeta',
    ...
    asistente: {
      ...
      confirmarDescartar: '¿Descartar este movimiento? Se perderán los datos ingresados.',
      siguiente: 'Siguiente',
      guardarBoton: 'Guardar',
      reintentar: 'Reintentar',
      editarAria: 'Editar {{campo}}',
      preguntaTipo: '¿Qué quieres registrar?',
      trasladoDeshabilitadoNota: 'Necesitas al menos 2 cuentas',
      preguntaCuentaIngreso: '¿A qué cuenta entró?',
      preguntaCuentaGasto: '¿De qué cuenta salió?',
      preguntaCuentaRetiro: '¿De qué cuenta salió?',
      preguntaCuentaOrigenTraslado: '¿Cuenta origen?',
      preguntaCuentaDestinoTraslado: '¿Cuenta destino?',
      preguntaTarjeta: '¿Con qué tarjeta?',
  ...
  viajes: {
    ...
    detalle: {
      ...
      volverCategoriasAria: 'Volver a las categorías del viaje',
      gastadoTitulo: 'Gastado',
      restanteTitulo: 'Restante',
      sinGastosCategoria: 'Aún no hay gastos en esta categoría.',
      abrirSinCategoriaAria: 'Ver gastos sin categoría',
    },
    resumen: {
